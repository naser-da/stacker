                ...
                <div class="p-6 text-gray-900">
                    ...
                    <div class="mb-4">
                        <form action="{{ route('products.index') }}" method="GET" class="flex gap-2">
                            <div class="flex-1">
                                <x-text-input type="text" name="search" placeholder="Search products..." class="w-full" value="{{ request('search') }}" />
                            </div>
                            ...
                            <tbody class="bg-white divide-y divide-gray-200">
                                @forelse($products as $product)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">${{ number_format($product->cost, 2) }}</div>
                                        </td>
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <div class="text-sm text-gray-900">${{ number_format($product->profit, 2) }}</div>
                                        </td>
