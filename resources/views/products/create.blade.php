                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('products.store') }}" class="space-y-6" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <x-text-input id="cost" name="cost" type="number" step="0.01" class="mt-1 block w-full" :value="old('cost')" required />
                            <x-input-error class="mt-2" :messages="$errors->get('cost')" />
                        </div>

                        <div>
                            <x-input-label for="profit" :value="__('Profit')" />
                            <x-text-input id="profit" name="profit" type="number" step="0.01" class="mt-1 block w-full" :value="old('profit')" required />
