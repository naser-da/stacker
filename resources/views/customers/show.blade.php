                        ...
                        <div>
                            ...
                            <dl class="space-y-4">
                                ...
                                <div>
                                    ...
                                    <dd class="mt-1 text-sm text-gray-900">{{ $customer->sales_count }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Total Spent</dt>
                                    <dd class="mt-1 text-sm text-gray-900">${{ number_format($customer->getTotalPurchaseValue(), 2) }}</dd>
                                </div>
                                <div>
                                    <dt class="text-sm font-medium text-gray-500">Last Purchase</dt>
                                    <dd class="mt-1 text-sm text-gray-900">{{ $customer->getLastPurchaseDate() ? $customer->getLastPurchaseDate()->format('M d, Y') : 'No purchases yet' }}</dd>
                                </div>
                            </dl>
                        </div>
                    </div>
